"""
Django settings for bloggerspark project.
...
SECRET_KEY = 'p-=t_d&#_&f*w^1sj5ycjn#%!4**-n@@&-3@1mnz9nbx7$nx@u'
...
ROOT_URLCONF = 'bloggerspark.urls'
...
WSGI_APPLICATION = 'bloggerspark.wsgi.application'
